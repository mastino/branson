...
class Photon
{
  ...
  void increment_scatter(void) {m_n_scatter++;}
  void increment_cross(void) {m_n_cross++;}
  ...
  uint32_t m_n_cross; //! Number of cell crossings this timestep
  uint32_t m_n_scatter; //! Number of scatter
